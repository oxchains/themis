...
public class MessageCopywrit {
    ...
    public static final String ADD_ORDERS_PLACE = "你的订单 {0} 成功拍下";
    public static final String SAVE_ADDRESS_KEY = "你的订单 {0} 成功上传公私钥";
    public static final String UPLOAD_TXID = "你的订单 {0} 成功上传交易id";
    public static final String CONFIRM_ORDER = "你的订单 {0} 已经确认,请及时处理";
    ...
    public static final String COMMENT_ORDERS = "你对订单 {0} 提交了评价";
    public static final String FINISH_ORDERS = "你的订单 {0} 双方已经评价完毕，交易完成";
