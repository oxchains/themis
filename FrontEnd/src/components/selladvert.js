...
class Selladvert extends Component {
    constructor(props) {
        super(props);
        this.state = {}
    }
...
let Adverting = React.createClass({
    ...
    render(){
        const TableLinks = [
            {num:"333333",type:"线下交易",country:"中国",price:"37000 CNY",bili:"1%",time:"2017-9-20",status:"已完成" },
        ]
        return (<div>
...
let Adverted = React.createClass({
    ...
    render(){
        const TableLinks = [
            {num:"444444",type:"线下交易",country:"中国",price:"37000 CNY",bili:"1%",time:"2017-9-20",status:"已完成" },
        ]
        return (<div>
            <table className="tableborder">
                <tbody>
...
export default connect(mapStateToProps,{})(Selladvert);
